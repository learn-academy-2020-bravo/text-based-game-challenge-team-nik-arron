...
puts "You wake up in your room, there are two pokeballs on your desk, wtf do you do? Select your choice (1-3)
    ...
    puts "select your Bahh
     ...
     puts "You enter Riches, and its drag queen night!! One of the drag queens is looking extra suspicious!
        ...
        puts "YOU JUST CAUGHT YOUR FIRST POKEMON! TURNS OUT PSYDUCK LIKES TO DRESS IN DRAG!TIME FOR SOME SHOTS LETS DANCE THE NIGHT AWAY YOU WIN!
